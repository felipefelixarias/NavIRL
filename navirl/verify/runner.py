...
def _write_report(report_path: Path, suite: str, pytest_ok: bool, pytest_out: str, rows: list[VerifyResult], thresholds: dict) -> None:
    ...
    lines = [
        ...
        f"  - teleport_thresh: scenario-specific (`evaluation.teleport_thresh`)",
        f"  - max_speed: scenario-specific (`evaluation.max_speed`)",
        f"  - max_accel: scenario-specific (`evaluation.max_accel`)",
        "",
        "## Scenario Results",
        "",
